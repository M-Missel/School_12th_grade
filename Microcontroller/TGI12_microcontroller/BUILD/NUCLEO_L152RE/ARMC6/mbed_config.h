...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC|USE_PLL_HSI                                                                     // set by target:MCU_STM32L1
...
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE_DEBUG_EXTRA                     512                                                                                              // set by library:rtos[STM32L1]
...
#define MBED_CONF_TARGET_GPIO_RESET_AT_INIT                                   1                                                                                                // set by target:MCU_STM32L1
